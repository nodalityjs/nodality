...
console.log(obj.customOptions);
/*console.warn(this.filtero("gradient", el.id, obj.customOptions));
console.log("---")
console.warn(this.filtero("transform", el.id, obj.customOptions));*/
...
//console.log(obj.customOptions);
        ...
        return new Wrapper(el.text || el.value)
            .set({
                id: el.id,
                class: el.class,
                color: el.color,
